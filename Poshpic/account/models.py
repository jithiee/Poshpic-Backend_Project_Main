...
class Userprofile(models.Model):
    ...
    profile_image = models.ImageField( upload_to=None, height_field=None, width_field=None, max_length=None,null=True,blank =True)
...
class PhotographerProfile(models.Model):
    ...
    user =models.OneToOneField(User ,related_name= 'photographerprofile', on_delete=models.CASCADE)
